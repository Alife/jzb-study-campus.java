...
pref("capability.principal.codebase.p1.id", "file://"); 
pref("capability.principal.codebase.p1.subjectName", "");
pref("capability.policy.policynames", "localfilelinks");
pref("capability.policy.localfilelinks.sites", "file://");
pref("capability.policy.localfilelinks.checkloaduri.enabled", "allAccess");
pref("capability.policy.localfilelinks.sites","http://www.example.com http://www.example.net file://");
pref("capability.principal.codebase.p0.granted","UniversalXPConnect  UniversalBrowserRead");
pref("capability.principal.codebase.p0.id", "file://");

//user_pref("capability.policy.trusted.sites", "http://localhost http://jzb.test.com");
...
// user_pref("capability.principal.codebase.p3.granted", "UniversalPreferencesWrite UniversalXPConnect UniversalBrowserWrite UniversalPreferencesRead UniversalBrowserRead");
// user_pref("capability.principal.codebase.p3.id", "http://jzb.test.com");
...
// ESTA LINEA TIENE QUE ESTAR AQUI, si se pone antes, parece que no funciona..
