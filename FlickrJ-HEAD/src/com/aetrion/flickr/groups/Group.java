...
public class Group implements BuddyIconable {
    ...
    public void setMembers(String members) {
        try {
            ...
            setMembers(0);
            if (Flickr.tracing) 
                Flickr._trace("trace: Group.setMembers(String) encountered a number format " + 
    ...
    public void setOnline(String online) {
    	try {
    		...
    		setOnline(0);
    		if (Flickr.tracing) 
    			Flickr._trace("trace: Group.setOnline(String) encountered a number format " + 
    ...
    public void setInChat(String inChat) {
        try {
            ...
            setInChat(0);
            if (Flickr.tracing) {
                Flickr._trace("trace: Group.setInChat(String) encountered a number format " + 
    ...
    public void setPhotoCount(String photoCount) {
        if (photoCount != null) {
            try {
                ...
                setPhotoCount(0);
                if (Flickr.tracing) {
                    Flickr._trace("trace: Group.setPhotoCount(String) encountered a number format " + 
