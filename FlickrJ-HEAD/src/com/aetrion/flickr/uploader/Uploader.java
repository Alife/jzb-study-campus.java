...
public class Uploader {
     ...
     */
    public Uploader(String apiKey, String sharedSecret,int connTimeoutSec, int readTimeoutSec) {
        try {
            String dottedQuad = Inet4Address.getByName(Flickr.DEFAULT_HOST).getHostAddress();
            
            this.apiKey = apiKey;
            this.sharedSecret = sharedSecret;
            this.transport = new REST(dottedQuad, 0, connTimeoutSec, readTimeoutSec);
