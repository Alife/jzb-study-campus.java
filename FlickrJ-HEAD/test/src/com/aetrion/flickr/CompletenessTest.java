...
public class CompletenessTest extends TestCase {
	...
	private boolean checkMethod(String fullMethodName) {
		...
		try {
			...
			if (!found) {
				Flickr._trace("ATTENTION: Method not implemented in flickrj: " + fqClassName + "." + methodName);
			}
		} catch (ClassNotFoundException e) {
			Flickr._trace("ATTENTION:  Class not implemented in flickrj: [" + fqClassName + "] (Method: " + methodName +")");
		}
		return found;
	}
}
