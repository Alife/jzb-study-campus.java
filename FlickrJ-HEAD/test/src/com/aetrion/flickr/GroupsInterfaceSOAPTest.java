...
//        Flickr._trace("category path: " + cat.getPath());
...
//            Flickr._trace("group id: " + group.getId());
//            Flickr._trace("group name: " + group.getName());
//        }
...
//            Flickr._trace("subcat id: " + subcategory.getId());
//            Flickr._trace("subcat name: " + subcategory.getName());
//        }
    }
    ...
    public void testBrowseWithId() throws FlickrException, IOException, SAXException {
        ...
        assertNotNull(subcats);
        assertTrue(subcats.size() > 0);
//        Flickr._trace("category name: " + cat.getName());
    }
