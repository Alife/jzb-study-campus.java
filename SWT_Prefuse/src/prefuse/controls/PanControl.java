...
public class PanControl extends ControlAdapter {
     ...
     */
    public PanControl() {
        this(LEFT_MOUSE_BUTTON, false, 0);
    }
    ...
    public PanControl(boolean panOverItem) {
        this(LEFT_MOUSE_BUTTON, panOverItem, 0);
    }
     ...
     * 
     * @param mouseButton
     *            the mouse button that should initiate a pan. One of {@link Control#LEFT_MOUSE_BUTTON}, {@link Control#MIDDLE_MOUSE_BUTTON}, or {@link Control#RIGHT_MOUSE_BUTTON}.
     */
    public PanControl(int mouseButton) {
        this(mouseButton, false, 0);
    }
     ...
     *            if true, the panning control will work even while the mouse is over a visual item.
     */
    public PanControl(int mouseButton, boolean panOverItem, int modifiers) {
    ...
    public void mousePressed(MouseEvent e) {
        if (m_modifiers != 0 && (e.getModifiers() & m_modifiers) != 0) {
