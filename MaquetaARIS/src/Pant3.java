...
public class Pant3 {
    ...
    protected void createContents() {
        ...
        label_1.setBackgroundImage(SWTResourceManager.getImage(Pant3.class, "Icono1.png"));
        ...
        for(int n=0;n<3;n++) {
            ...
            item1.setText(new String[] { "Operación @"+n, "Servicio 1", "Descripción del servicio "+n });
        }
        
        for(int n=0;n<5;n++) {
            final TableItem item1 = new TableItem(m_Table, SWT.NONE);
            item1.setText(new String[] { "Operación @"+new Character((char)(65+n)), "Servicio A", "Descripción del servicio "+new Character((char)(65+n)) });
        }
        ...
        label_3.setBackgroundImage(SWTResourceManager.getImage(Pant3.class, "Icono2.png"));
