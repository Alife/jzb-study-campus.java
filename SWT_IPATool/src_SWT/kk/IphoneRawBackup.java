...
public class IphoneRawBackup {
    ...
    public static void main(String[] args) {
        try {
            ...
            IphoneRawBackup me = new IphoneRawBackup();
    ...
    private void backupAllInfo() throws Exception {
        
        String pcBaseFolder = "C:\\Documents and Settings\\n63636.SCISBMIG\\Desktop\\_backup\\iphone\\backup\\";
        String iphoneFolder = "/private/var/mobile/Library/AddressBook";
        String pcFolder = pcBaseFolder+"AddressBook";
        String fileNames[]= {"AddressBook.sqlitedb","AddressBookImages.sqlitedb"};
    }
