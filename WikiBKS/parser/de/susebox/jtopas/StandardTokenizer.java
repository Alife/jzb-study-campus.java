 ...
 * </p>
 * <p>
 * Beside the {@link Tokenizer} interface, the class <code>StandardTokenizer</code> provides some basic features for cascading (nested) tokenizers. Consider the usual HTML pages found today in the
 * WWW. Most of them are a mixture of regular HTML, cascading style sheets (CSS) and embedded JavaScript. These different languages use different syntaxes, so one needs varous tokenizers on the same
 * input stream.
 * </p>
 * <p>
 * This {@link Tokenizer} implementation is not synchronized. Take care when using with multible threads.
 * </p>
 * 
 * @see Tokenizer
...
public class StandardTokenizer extends AbstractTokenizer implements Tokenizer, TokenizerPropertyListener {
    ...
    /**
     * Base class for the various implementations of the {@link de.susebox.jtopas.spi.DataProvider} interface for the {@link StandardTokenizer}.
     */
    private abstract class AbstractDataProvider implements DataProvider {
        ...
        /**
         * The constructor takes the nessecary parameters for the methods defined below
         * 
         * @param startPosition
         *            valid data start here
         * @param length
         *            count of characters starting at startPosition
         */
        ...
        /**
         * Retrieving the maximum number of characters in the array provided by {@link getData} that can be analyzed by the calling {@link de.susebox.jtopas.spi.DataMapper}.
         * 
         * @param testChar
        ...
        /**
         * Retrieving the position where the data to analyze start in the buffer provided by {@link #getData}. The calling {@link de.susebox.jtopas.spi.DataMapper} must not access data prior to this
        ...
        /**
         * Setting the start position and the length in the data buffer of this instance.
         * 
         * @param startPosition
         *            valid data start here
         * @param length
    ...
    /**
     * Implementation of the {@link de.susebox.jtopas.spi.DataProvider} interface for the {@link StandardTokenizer}.
     */
    private final class CharArrayDataProvider extends AbstractDataProvider implements DataProvider {
         ...
         * 
         * @param index
         *            an index between 0 and {@link #getLength}
        ...
        /**
         * Returning the valid data range of this <code>DataProvider</code> as a string. This method is an alternative to {@link #getDataCopy}.
         * 
    ...
    /**
     * Implementation of the {@link de.susebox.jtopas.spi.DataProvider} interface for {@link CharSequenceTokenizerSource} sources.
     */
    private final class StringDataProvider extends AbstractDataProvider implements DataProvider {
         ...
         * 
         * @param index
         *            the index of the character starting from {@link #getStartPosition}
         * @return the character at the given position
         */
        @Override
        public char getCharAt(int index) {
    ...
    /**
     * If a {@link CharSequenceTokenizerSource} is used, this member is set to it.
     */
    protected CharSequenceTokenizerSource _charSequenceTokenizerSource = null;

    /**
     * The {@link de.susebox.jtopas.spi.DataProvider} instance for this object. This instance is kept due to a significant performance boost compared with construction of a <code>DataProvider</code>
     * every time {@link #getDataProvider} is called.
     */
    ...
    /**
     * Mapping of index 0 of {@link #_inputBuffer} to the absolute start of the input stream.
     */
    ...
    /**
     * Contructing a <code>StandardTokenizer</code> with a backing {@link TokenizerProperties} instance.
     * 
     * @param properties
    ...
    /**
     * This method returns the absolute offset in characters to the start of the parsed stream. See the method description in {@link Tokenizer}.
     * 
    ...
    /**
     * Additionally to the common behaviour implemented in {@link #de #setSource}, this method ajusts the state speicific to the <code>StandardTokenizer</code> class.
     * 
     * @param source
