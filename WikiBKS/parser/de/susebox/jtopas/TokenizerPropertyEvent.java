...
/**
 * <p>
 * The class <code>TokenizerPropertyEvent</code> describes changes in {@link TokenizerProperties} objects. Instances of this class are produced by <code>TokenizerProperties</code> and passed to
 * {@link TokenizerPropertyListener} objects that are registered with the issuing <code>TokenizerProperties</code> instance.
 * </p>
 * 
...
public class TokenizerPropertyEvent {
    ...
    /**
     * This constructor takes the type of the event and the {@link TokenizerProperty} that changed.
     * 
     * @param type
     *            type of the event, one of the <code>PROPERTY_...</code> constants
     * @param property
     *            the property that was added, removed or the new value of a modified one
     */
    ...
    /**
     * This constructor takes the type of the event and the {@link TokenizerProperty} that changed together with its old value.
     * 
     * @param type
     *            type of the event, one of the <code>PROPERTY_...</code> constants
     * @param property
     *            the property that was added, removed or the new value of a modified one
     * @param oldProperty
     *            the old value of the property that modified
     */
    ...
    public boolean equals(Object that) {
        ...
        if (getType() == thatEvent.getType() && (_property == thatProp || (_property != null && _property.equals(thatProp)))
    ...
    /**
     * Retrieving the property that was set before the modification. The method returns <code>null</code> when the event is <strong>NOT</strong> {@link #PROPERTY_MODIFIED}.
     * 
    ...
    /**
     * Retrieving the event type. This will usually be one of the <code>PROPERTY_...</code> constants.
     * 
    ...
    /**
     * Setting the {@link TokenizerProperty} that was changed. This is a valid method for the event {@link #PROPERTY_MODIFIED}.
     * 
     * @param property
     *            the previously set {@link TokenizerProperty}
     */
     ...
     * 
     * @param property
     *            the added, removed or modified {@link TokenizerProperty}
     */
    ...
    /**
     * Setting the event type. Use one of the <code>PROPERTY_...</code> constants for the parameter.
     * 
     * @param type
     *            the event type
     * @see #getType
