 ...
 * @author Heiko Blau
 */
public class TokenizerException extends Exception implements ThrowableList {
    ...
    /**
     * This constructor should be used for wrapping another throwable. While reading data an IOException may occur, but the {@link Tokenizer} interface requires a <code>TokenizerException</code>.
     * Simply use: <blockquote>
     * 
     * <pre>
     * try {
     *   ...
    ...
    /**
     * This is the most complex way to construct a <CODE>TokenizerException</CODE>. An inner throwable is accompanied by a format string and its arguments. Use this constructor in language-sensitive
     * contexts or for formalized messages. The meaning of the parameters is explained in the other constructors.
     * 
     * @param ex
     *            the inner throwable
     * @param fmt
    ...
    /**
     * Implementation of the standard {@link java.lang.Throwable#getMessage} method. It delegates the call to the central {@link de.susebox.java.lang.ThrowableMessageFormatter#getMessage} method.
     * 
