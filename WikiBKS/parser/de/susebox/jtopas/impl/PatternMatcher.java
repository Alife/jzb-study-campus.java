...
/**
 * <p>
 * Implementation of the {@link PatternHandler} interface using the JDK 1.4 package <code>java.util.regex</code>.
 * </p>
 * 
 * @author Heiko Blau
 */
public class PatternMatcher implements PatternHandler {
    ...
    /**
     * An implementation of the JDK 1.4 {@link java.lang.CharSequence} interface backed by a {@link DataProvider}.
     */
    private final class DataProviderCharSequence implements CharSequence {
         ...
         * 
         * @param dataProvider
         *            the backing <code>DataProvider</code>
         */
        ...
        /**
         * The constructor takes the reference to the {@link DataProvider}, the start position and length. It is nessecary for the {@link #subSequence} method
         * 
         * @param dataProvider
         *            the backing <code>DataProvider</code>
         */
        ...
        /**
         * Returns the character at the specified index. An index ranges from zero to <code>length() - 1</code>. The first character of the sequence is at index zero, the next at index one, and so on,
        ...
        /**
         * Returns the length of this character sequence. The length is the number of 16-bit Unicode characters in the sequence. </p>
         * 
        ...
        /**
         * Returns a new character sequence that is a subsequence of this sequence. See {@link java.lang.CharSequence#subSequence} for details.
         * 
         * @param start
         ...
         *             if <code>start</code> or <code>end</code> are negative, if <code>end</code> is greater than <code>length()</code>, or if <code>start</code> is greater than <code>end</code>
         */
        @Override
    ...
    private final class LocalResult implements PatternHandler.Result {
         ...
         * @param lengthOfMatch
         *            the detected number of characters that match the pattern
         * @param groups
         *            array with the capturing groups
         */
        ...
        /**
         * Returns the {@link TokenizerProperty} that describes the pattern that matches data passed to {@link PatternHandler#matches}.
         * 
    ...
    /**
     * The constructor takes a pattern and the {@link TokenizerProperty} object associated with this instance of <code>PatternMatcher</code>. The global flags are passed to control the behaviour for
     * attributes that are not specified in the property itself (e.g. case-sensitivity).
     * 
     * @param prop
     *            the {@link TokenizerProperty} associated with this object
     * @param globalFlags
     *            flags that are to be used if not set explicitely in the property
    ...
    /**
     * The method is a dummy implementation for the interface {@link PatternHandler} and always returns <code>true</code>.
     * 
     ...
     *            if <code>true</code> only unbounded pattern should be checked (pattern not enclosed in whitespaces, separators etc.)
    ...
    /**
     * Setting the {@link TokenizerProperty} for this <code>PatternMatcher</code>. This method will recompile the regular expression pattern.
     * 
     * @param prop
     *            the {@link TokenizerProperty} associated with this object
     * @throws NullPointerException
