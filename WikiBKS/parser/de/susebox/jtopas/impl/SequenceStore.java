...
/**
 * This class is used by {@link de.susebox.jtopas.StandardTokenizerProperties} to store and search special sequences, comments and strings as well as keywords. The class is not suitable for standalone
 * use since it does not check parameters for <code>null</code> values, assumes a thread-safe context etc.
 * 
...
public class SequenceStore implements SequenceHandler, KeywordHandler {
    ...
    final class PropertyList {
         ...
         * 
         * @param property
         *            a {@link TokenizerProperty} instance
         */
        ...
        /**
         * Constructor taking a {@link TokenizerProperty} and the next list element. For the next element, <code>null</code> is a valid value.
         * 
         * @param property
         *            a {@link TokenizerProperty} instance
         * @param next
         *            the following {@link PropertyList} element
         */
    ...
    /**
     * Iterator for comments, strings and ordinary special sequences. Instances of this inner class are returned when a call to {@link #getSpecialSequences} is done. Each element of the enumeration
     * contains a {@link TokenizerProperty} element, that in turn has the comment, special sequence etc. together with its companion
     */
    final class SpecialSequencesIterator implements Iterator {
        ...
        /**
         * Checking for the next element in a special sequence list, that has the required type. This method is the one that ultimately decides if there are more elements or not.
         * 
         * @return <code>true</code> if there is a matching {@link TokenizerProperty} element, <code>false</code> otherwise
         */
    ...
    /**
     * The constructor initializes a <code>SequenceStore</code> with the given comparision policy (prefix comparison).
     * 
     * @param useExactLength
     *            if <code>true</code> search only for a property that has the length of {@link de.susebox.jtopas.spi.DataProvider#getLength}
     */
     ...
     * 
     * @param property
     *            the description of the new keyword
    ...
    /**
     * This method returns an {@link java.util.Iterator} of {@link TokenizerProperty} objects describing keywords.
     * 
     * @return enumeration of {@link TokenizerProperty} objects representing keywords
     */
    ...
    /**
     * This method returns the length of the longest special sequence, comment or string prefix that is known to this <code>SequenceStore</code>. See {@link de.susebox.jtopas.spi.SequenceHandler} for
     * details.
     * 
     ...
     * 
     * @param type
     *            type of special sequence like {@link de.susebox.jtopas.Token#STRING}
    ...
    /**
     * This method returns <code>true</code> if there are any keywords registered in this instance. See the {@link de.susebox.jtopas.spi.KeywordHandler} interface for details.
     * 
     * @return <code>true</code> if there are any keywords available, <code>false</code> otherwise.
     */
    @Override
    ...
    /**
     * This method returns <code>true</code> if there are any special sequences, strings or comments registered in this instance. See the {@link de.susebox.jtopas.spi.SequenceHandler} interface for
     * details.
     * 
     * @return <code>true</code> if there are any special sequences, strings or comments available, <code>false</code> otherwise.
     */
    @Override
    ...
    /**
     * This method checks if the given data form a keyword. See {@link de.susebox.jtopas.spi.KeywordHandler} for details.
     * 
     * @param dataProvider
     *            the source to get the data range from
     * @return a {@link de.susebox.jtopas.TokenizerProperty} if keyword has been found, <code>null</code> otherwise
    ...
    /**
     * This method checks if a given range of data starts with a special sequence, a comment or a string. See {@link de.susebox.jtopas.spi.SequenceHandler} for details.
     * 
     * @param dataProvider
     *            the source to get the data range from
    ...
    /**
     * Compare tho characters. Returns the difference of the to characters, 0 if they are equal. The default implementation compares case-sensitive, for the lexicographical solution see
     * {@link NoCaseSequenceStore}..............
     * 
     * @param char1
    ...
    /**
     * The method returns the normalized start character. This default implementation returns the given character itself, for case-insensitive handling see the derived class
     * {@link NoCaseSequenceStore}.
     * 
     * @param startChar
     *            a not normalized start character
    ...
    /**
     * Compare method for sequences. Longer Strings are greater, shorter are lesser. Strings with equal lengths are compared in the usual way.
     * 
     * @param thisImage
     ...
     * @param fromIndex
     *            start comparison from this index
    ...
    /**
     * Compare method for a string and a character array. The method assumes that the character array holds at least as many characters as the given string. <br>
     * See {@link #compare} for details how the comparison is performed.
     * 
     * @param prefix
     *            string to compare
     * @param dataProvider
     *            source to get the other characters to compare
     * @param offset
     *            start comparison from this index
     * @return 0 if equal, < 0 if thisImage < thatImage, > 0 otherwise
     */
    ...
    /**
     * Insert/replace a property in a property list. The list is ordered by string comparison. This is important for the search in {@link #startsWithSequenceCommentOrString}.
     * 
     * @param list
     *            insert or replace in this list
     * @param property
     *            the description of the new sequence
     * @return the previously version of the given property or <code>null</code>
     */
    ...
    /**
     * Search a string in the given list. Optionally, remove it. Removal may also reorganize the indexed array or non-ASCII map.
     * 
     * @param image
     *            sequence to search
     * @param removeIt
     *            if <code>true</code> remove a found sequence from the list
