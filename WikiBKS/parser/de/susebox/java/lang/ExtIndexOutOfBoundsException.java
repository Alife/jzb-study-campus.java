...
/**
 * Implementation of the {@link ThrowableList} interface for the JDK {@link java.lang.IndexOutOfBoundsException}.
 * 
 * @version 1.00, 2001/06/26
 * @author Heiko Blau
 */
public class ExtIndexOutOfBoundsException extends IndexOutOfBoundsException implements ThrowableList {
    ...
    /**
     * This constructor should be used for wrapping another throwable. While reading data an IOException may occur, but a certain interface requires a <code>java.sql.SQLException</code>. Simply use:
     * <blockquote>
     * 
     * <pre>
     * try {
    ...
    /**
     * If one likes to add ones own information to a throwable, this constructor is the easiest way to do so. By using such an approach a throwable trace with useful additional informations (which
