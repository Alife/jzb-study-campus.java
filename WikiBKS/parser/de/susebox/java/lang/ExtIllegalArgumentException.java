...
/**
 * Implementation of the {@link ThrowableList} interface for the well-known JDK {@link java.lang.IllegalArgumentException}.
 * 
 * @author Heiko Blau
 */
public class ExtIllegalArgumentException extends IllegalArgumentException implements ThrowableList {
    ...
    /**
     * If one likes to add ones own information to a {@link java.lang.Throwable}, this constructor is the easiest way to do so. By using such an approach a <code>Throwable</code> trace with useful
     * additional informations (which file could not be found, what username is unknown) can be realized: <blockquote>
     * 
     * <pre>
     * try {
     *   ...
    ...
    /**
     * This is the most complex way to construct an <code>ThrowableList</code>- Throwable. An inner {@link java.lang.Throwable} is accompanied by a format string and its arguments. <br>
     * Use this constructor in language-sensitive contexts or for formalized messages. The meaning of the parameters is explained in the other constructors.
     * 
     * @param throwable
     *            the inner throwable
     * @param fmt
