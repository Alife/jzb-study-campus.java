...
/**
 * <p>
 * The <code>DefaultEnvironment</code> implements the {@link Environment} interface using the JDK class {@link java.lang.System}. Instances of this class are returned by the singleton
 * {@link EnvironmentProvider} ({@link EnvironmentProvider#getEnvironment}) if there is no other <code>Environment</code> available for the caller.
 * </p>
 * 
 * @see Environment
...
public class DefaultEnvironment implements Environment {
    ...
    /**
     * This method stores the exit code of an application. It can be called more than once.
     * 
     * @param status
