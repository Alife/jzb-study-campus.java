...
/**
 * Implementation of the {@link ThrowableList} interface for the well-known JDK {@link java.lang.UnsupportedOperationException}.
 * 
 * @author Heiko Blau
 */
public class ExtUnsupportedOperationException extends UnsupportedOperationException implements ThrowableList {
    ...
    /**
     * This constructor should be used for wrapping another exception. While reading data an IOException may occur, but a certain interface requires a <code>SQLException</code>. Simply use:
     * <blockquote>
     * 
     * <pre>
     * try {
