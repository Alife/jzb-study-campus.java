...
/**
 * <p>
 * The <code>EnvironmentProvider</code> is a singleton object to store and provide {@link Environment} instances. It provides the possibility to register and retrieve <code>Environment</code>
 * instances on a per object or per class base.
 * </p>
 * <p>
 * Since an <code>Environment</code> is designed as a substitute for some features of the JDK {@link java.lang.System} class, the retrieval of the <code>Environment</code> associated with a class
 * should be possible without additional information about the context. Class-based <code>Environment</code> objects are also associated with the thread, that actually registered the instance.
 * </p>
 * 
 * @author Heiko Blau
 */
public final class EnvironmentProvider {
    ...
    /**
     * This class stores a {@link java.lang.Class} object and the current thread to form a key for class-based environment registration
     * 
    ...
    static final class EnvironmentKey {
        ...
        /**
         * The constructor takes the {@link java.lang.Class} object that forms the first part of the key. It automatically adds the calling thread to the key
         * 
         * @param cl
         *            the <code>Class</code> object that is the first part of the key.
         */
    ...
    /**
     * This method returns an {@link Environment} instance that has been registered for the given object. <br>
     * If there is no specific <code>Environment</code> instance available for the object then its class name is used to find a more general <code>Environment</code> instance. <br>
     * If still no <code>Environment</code> could be found a default <code>Environment</code> is returned, usually a {@link DefaultEnvironment} instance. <br>
     * The method will always return an <code>Environment</code> instance except for runtime exceptions.
     * 
     * @param obj
     *            the object thats environment should be retrieved
    ...
    /**
     * Removing a registered {@link Environment}. If the given object is not known to the <code>EnvironmentProvider</code> the method does nothing.
     * 
     * @param obj
     *            the object thats {@link Environment} should be removed
     */
    ...
    /**
     * Registering an {@link Environment} for the given object. If this object is a {@link java.lang.Class} instance, the <code>Environment</code> is common for all instances of this class and its
     * subclasses.
     * 
     * @param obj
     *            the object the given {@link Environment} is for
     * @param env
     *            the {@link Environment} to store
