 ...
 * For these to run, make sure that the sources themselves or at least the *.xsl files, the *.gml files, the *.ygf
...
public class DemoBrowser {
  ...
  private static final String PLAY_BUTTON = "/demo/browser/resource/Play24.gif";
  private static final String STOP_BUTTON = "/demo/browser/resource/Stop24.gif";
  ...
  private JComponent createContentPane() {
    ...
    if ( startIconResource != null ) {
      ...
      // only delete the button text if the GIF was succesfully read
  ...
  private static final class DisplayableRenderer implements TreeCellRenderer {
    ...
    private final static Font defaultFont = new Font( "SansSerif", Font.PLAIN, 12 );
    private final static Font boldFont = new Font( "SansSerif", Font.BOLD, 12 );
    private final static Font italicFont = new Font( "SansSerif", Font.ITALIC, 12 );
...
//      this.nonExecutableColor = Color.RED.darker();
  ...
  private static final class AntiAliasingEditorPane extends JEditorPane {
    public AntiAliasingEditorPane( final String type, final String text ) {
      super( type, text );
    }
