 ...
 * {@link y.layout.tree.TreeLayouter}, {@link y.layout.tree.BalloonLayouter}, {@link y.layout.tree.ARTreeLayouter} and {@link y.layout.tree.HVTreeLayouter}.
 *
 */
public class TreeLayoutModule extends LayoutModule
{
  ...
  public void mainrun()
  {
    ...
    else if(style.equals(HV))
    {
      ...
      Dimension dim = getGraph2DView().getSize();
    ...
    try {
      ...
      if(trs != null) layouter.removeStage(trs);
    }
  }
}