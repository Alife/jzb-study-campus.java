...
{  
  public static final String EDGE_LABEL_MODEL = "EDGE_LABEL_MODEL";
  public static final String EDGE_LABELING = "EDGE_LABELING";
  public static final String LABELING = "LABELING";
  public static final String REMOVE_FALSE_CROSSINGS = "REMOVE_FALSE_CROSSINGS";
  public static final String USE_TRANSPOSITION = "USE_TRANSPOSITION";
  public static final String WEIGHT_HEURISTIC = "WEIGHT_HEURISTIC";
  public static final String NODE_ORDER = "NODE_ORDER";
  public static final String RANDOMIZATION_ROUNDS = "RANDOMIZATION_ROUNDS";
  public static final String RANKING_POLICY = "RANKING_POLICY";
  public static final String NODE_RANK = "NODE_RANK";
  ...
  public static final String TIGHT_TREE = "TIGHT_TREE";
  public static final String DOWNSHIFT_NODES = "DOWNSHIFT_NODES";
  public static final String NO_RERANKING = "NO_RERANKING";
  ...
  public static final String GROUP_POLICY  = "GROUP_LAYOUT_POLICY";
  public static final String IGNORE_GROUPS = "IGNORE_GROUPS";
  public static final String LAYOUT_GROUPS = "LAYOUT_GROUPS";
  public static final String FIX_GROUPS    = "FIX_GROUPS";
  public static final String ENABLE_GLOBAL_SEQUENCING = "ENABLE_GLOBAL_SEQUENCING";
  ...
  public static final String[] topoLayerPolicy = {
    NO_RERANKING,
    DOWNSHIFT_NODES,
    TIGHT_TREE,
    SIMPLEX,
  ...
  public static final String[] weightHeuristic = { 
    BARYCENTER,
    MEDIAN
  };
  
  public static final String[] layoutStyles = {
    PENDULUM,
    LINEAR_SEGMENTS,
    POLYLINE,
    TREE,
  ...
  public static final String[] routingStyles = {
    POLYLINE,
    ORTHOGONAL
  };

  public static final String[] edgeLabeling = {
    NONE,
    HIERARCHIC,
    GENERIC
  };
  
  public static final String[] edgeLabelModel = {
    BEST,
    AS_IS,
    CENTER_SLIDER,
    SIDE_SLIDER,
  ...
  public void mainrun()
  {
    ...
    if(HierarchyManager.containsGroupNodes(graph))
    {
      ...
      {
        glc = new GroupLayoutConfigurator(graph);
        glc.prepareAll();
