...
public class LayoutWithoutAView
{
  ...
  public void doit()
  {
    ...
    spc.set(e2, PortConstraint.create(PortConstraint.EAST));
    tpc.set(e2, PortConstraint.create(PortConstraint.SOUTH));
    ...
    layouter.setLayoutStyle(HierarchicLayouter.MEDIAN_SIMPLEX);
    ...
    D.bug("ell1 upper left location = " + getEdgeLabelLocation(graph,e1,ell1));  
    D.bug("ell2 upper left location = " + getEdgeLabelLocation(graph,e1,ell2));  
