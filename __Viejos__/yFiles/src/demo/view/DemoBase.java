 ...
 * <p/>
 * To avoid problems with "calls to overriden method in constructor", do not initialize the demo
...
public abstract class DemoBase {
  ...
  protected JToolBar createToolBar() {
    ...
    if ( isDeletionEnabled() ) {
      toolBar.add( new AbstractAction( "Clear", new ImageIcon( ClassLoader.getSystemResource( "demo/view/resource/New16.gif" ) ) ) {
      ...
      toolBar.add( new DeleteSelection() );
    }
