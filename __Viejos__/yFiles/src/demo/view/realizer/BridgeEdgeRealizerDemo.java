 ...
 * It demonstrates how to wrap a {@link GenericEdgeRealizer.Painter} implementation of a customized
...
public class BridgeEdgeRealizerDemo extends DemoBase {
  ...
  public BridgeEdgeRealizerDemo() {
    ...
    // initialize the default edgerealizer to the type we just registered...
    ...
    // set an appropriate graph2drenderer that resets the bridgecalculator initially for each painting
    ...
    loadGraph( "resource/bridgeEdgeRealizer.gml" );
  }
  ...
  /**
   * Wrapping GenericEdgeRealizer.Painter implemenation that modifies the given
