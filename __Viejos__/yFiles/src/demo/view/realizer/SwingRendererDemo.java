...
/**
 * This demo shows how yFiles can deal with Swinglike cell rendering and cell editing mechanisms.
...
public class SwingRendererDemo extends DemoBase
{
  ...
  public SwingRendererDemo()
  {
    ...
    view.getGraph2D().createNode(150, 50, 200, 50, "");

    // and another one of the other kind
    gnr.setConfiguration("JTable");
    view.getGraph2D().createNode(150, 200, 150, 150, "");
  ...
  protected void registerViewModes() {
    ...
    // create a dataprovider that dynamically switches between the different NodeCellEditor instances
  ...
  {
    /**
     * the textfield that holds/displays the actual data
     */
  ...
  {
    initLnF();
    SwingRendererDemo demo = new SwingRendererDemo();
    demo.start("Swing Renderer Demo");
  }
}
