...
public class UMLClassNodeRealizer extends ShapeNodeRealizer
{
  ...
  /**
   * Instantiates a new UMLNodeRealzier as a copy of a given 
   * realizer.
   */ 
  ...
  /**
   * Set the size of this realizer automatically. This method will apapt the size
   * of this realzier so that the labels defined for it will fit within its 
   * bounding box.
   */
