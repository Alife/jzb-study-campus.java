...
/**
 * This simple demo shows how to use the new {@link IncrementalHierarchicLayouter}
...
public class SimpleIncrementalHierarchicLayouterDemo extends DemoBase
{
  ...
  {
    initLnF();
    SimpleIncrementalHierarchicLayouterDemo demo = new SimpleIncrementalHierarchicLayouterDemo();
    demo.start("Simple IncrementalHierarchicLayouter Demo");
  }
}
