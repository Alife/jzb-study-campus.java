 ...
 * <br>
 * This demo offers its functionality via context menues. The actual selected
...
public class AssistantPlacerDemo extends AbstractTreeDemo {
  public static void main( String[] args ) {
    initLnF();
    AssistantPlacerDemo demo = new AssistantPlacerDemo();
    demo.start( "Assistant Placer Demo" );
  }
