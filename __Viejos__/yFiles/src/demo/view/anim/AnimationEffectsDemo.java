...
public final class AnimationEffectsDemo extends AnimationEffectsDemoBase
{
   ...
   * Creates a new AnimationEffectsDemo.
   */
  private AnimationEffectsDemo( final GuiFactory i18n,
...
//      visited2.setTargetArrow(er.getSourceArrow());
  ...
  /**
   * Demontrates animated creation of nodes.
  ...
  /**
   * Demontrates animated creation of edges.
  ...
  /**
   * Demontrates animated deletion of nodes.
   * @param nr   the <code>NodeRealizer</code> representing the node
   */
  ...
  /**
   * Demontrates animated deletion of edges.
   * @param er   the <code>EdgeRealizer</code> representing the edge
   */
  ...
  /**
   * Demontrates animated deletion of all selected graph elements.
   */
...
//          view.updateView();
   ...
   */
  private final static class RemoveNode implements AnimationObject
  {
   ...
   */
  private final static class RemoveEdge implements AnimationObject
  {
