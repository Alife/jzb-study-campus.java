...
abstract class AnimationEffectsDemoBase
{
   ...
   * @param wantsRadioButtons
   */
  AnimationEffectsDemoBase( final GuiFactory i18n,
  ...
  void openGraph( final String resource )
  {
    ...
    if (url != null)
    {
      ...
      try
      {
        ...
        getIoHandlerByExt(name).read(graph, name);
      }
    ...
    else
    {
      ...
      else
      {
        try
        {
          throw new Exception("Cannot locate file: " + resource);
        }
        catch (Exception ex)
        {
          D.show(ex);
  ...
  void localizeAction( final Action action, final String key )
  {
    ...
    if (iconUrl != null)
    {
      action.putValue(Action.SMALL_ICON, new javax.swing.ImageIcon(iconUrl));
    }
  }
  ...
  {
    final OptionHandler oh = new OptionHandler(DEMO_NAME);

    final ConstraintManager cm = new ConstraintManager(oh);
    ...
    item = oh.addEnum("createNode", new Byte[] {noAnim, blurIn,  fadeIn,  implode, whirlIn}, 4);
    item.setAttribute(EnumOptionItem.ATTRIBUTE_RENDERER, elementsRenderer);
    section.addItem(item);
    item = oh.addEnum("deleteNode", new Byte[] {noAnim, blurOut, fadeOut, explode, whirlOut}, 1);
    item.setAttribute(EnumOptionItem.ATTRIBUTE_RENDERER, elementsRenderer);
    section.addItem(item);
    item = oh.addEnum("createEdge", new Byte[] {noAnim, blurIn,  fadeIn,  implode, extract}, 2);
    item.setAttribute(EnumOptionItem.ATTRIBUTE_RENDERER, elementsRenderer);
    section.addItem(item);
    item = oh.addEnum("deleteEdge", new Byte[] {noAnim, blurOut, fadeOut, explode, retract}, 4);
    item.setAttribute(EnumOptionItem.ATTRIBUTE_RENDERER, elementsRenderer);
    section.addItem(item);
    ...
    item = oh.addEnum("animation", new Byte[]{
    ...
    item = oh.addEnum("animateLoad_graph", new String[]{"big", "small"}, 0);
    item.setAttribute(DefaultEditorFactory.ATTRIBUTE_ENUM_STYLE,
                      DefaultEditorFactory.STYLE_RADIO_BUTTONS);
    group.addItem(item);
    item = oh.addEnum("animateLoad_nodeOrder", order, 0);
    item.setAttribute(EnumOptionItem.ATTRIBUTE_RENDERER, orderRenderer);
    group.addItem(item);
    group.addItem(oh.addBool("animateLoad_obeyEdgeDirection", false));
    group.addItem(oh.addDouble("animateLoad_ratio", 0.15, 0.1, 1.0));
    ...
    item = oh.addEnum("animateClear_nodeOrder", order, 0);
    item.setAttribute(EnumOptionItem.ATTRIBUTE_RENDERER, orderRenderer);
    group.addItem(item);
    group.addItem(oh.addBool("animateClear_obeyEdgeDirection", false));
    group.addItem(oh.addDouble("animateClear_ratio", 0.15, 0.1, 1.0));
    ...
    group.addItem(oh.addColor("colorVisited", Color.RED, true, true, false, false));
    group.addItem(oh.addColor("colorUnvisited", Color.BLACK, true, true, false, false));
    ...
    group.addItem(oh.addDouble("zoom_factor", 1.0, 0.1, 16.0));
    ...
    group.addItem(oh.addDouble("translateX", 50));
    group.addItem(oh.addDouble("translateY", 50));
    group.addItem(oh.addDouble("width", 100));
    group.addItem(oh.addDouble("height", 25));
    group.addItem(oh.addColor("fillColor", Color.RED, true, true, false, false));
    group.addItem(oh.addColor("fillColor2", Color.GREEN, true, true, false, false));
    group.addItem(oh.addColor("lineColor", Color.BLACK, true, true, false, false));
    ...
    group.addItem(oh.addDouble("resize_width", 100));
    group.addItem(oh.addDouble("resize_height", 100));
    ...
    group.addItem(oh.addInt("repetitions", 1, 1, 25));
    cm.setEnabledOnValueEquals("animation", blink, group);
    addItems(group, section);

    oh.useSection("global");
    oh.addDouble("speed", 1.0, 0.25, 4.0, 2);
  ...
  private IOHandler getIoHandlerByExt( final String filename )
  {
    if (filename.endsWith(".gml"))
    {
      return new GMLIOHandler();
    }
    else if (filename.endsWith(".ygf"))
    {
  ...
  private abstract class I18nRenderer
