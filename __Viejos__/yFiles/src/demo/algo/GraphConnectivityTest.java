...
public class GraphConnectivityTest {
  ...
  private void test1( int seed ) {
    ...
    t1.start();
    //calculatethe connected components of the graph
    ...
    //dispose dynamic nodemap sinbce it is not needed anymore.
