...
/** This class is used in conjunction with {@link CustomGMLDemo}.
  ...
  */  
  public void encode(Object item, y.io.gml.GMLEncoder encoder) throws java.io.IOException
  {
    ...
    for (java.util.Iterator it = list.iterator(); it.hasNext();){
      demo.io.CustomGMLDemo.NodeData data = (demo.io.CustomGMLDemo.NodeData) it.next();
