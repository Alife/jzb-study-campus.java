 ...
 * 
 * Created on 28 April 2002, 17:40 Modified 04 Aug 2002 - Adjusted javadoc - Added Modified 29 Oct 2002 (v1.2) - Stored IFD directories in separate tag-spaces - iterator() now returns an Iterator over
 * a list of TagValue objects - More getDescription() methods to detail GPS tags, among others - Put spaces between words of tag name for presentation reasons (they had no significance in compound
 * form)
 */
...
public final class Metadata implements Serializable {
    ...
    /**
     * Returns a <code>Directory</code> of specified type. If this <code>Metadata</code> object already contains such a directory, it is returned. Otherwise a new instance of this directory will be
     * created and stored within this Metadata object.
     * 
     * @param type
    ...
    /**
     * Creates an Iterator over the tag types set against this image, preserving the order in which they were set. Should the same tag have been set more than once, it's first position is maintained,
     * even though the final value is used.
     * 
