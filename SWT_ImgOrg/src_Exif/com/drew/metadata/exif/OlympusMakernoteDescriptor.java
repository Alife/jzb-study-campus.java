...
public class OlympusMakernoteDescriptor extends TagDescriptor {
    ...
    public String getDigiZoomRatioDescription() throws MetadataException {
        if (!_directory.containsTag(OlympusMakernoteDirectory.TAG_OLYMPUS_DIGI_ZOOM_RATIO))
            return null;
    ...
    public String getJpegQualityDescription() throws MetadataException {
        if (!_directory.containsTag(OlympusMakernoteDirectory.TAG_OLYMPUS_JPEG_QUALITY))
            return null;
    ...
    public String getMacroModeDescription() throws MetadataException {
        if (!_directory.containsTag(OlympusMakernoteDirectory.TAG_OLYMPUS_MACRO_MODE))
            return null;
    ...
    public String getSpecialModeDescription() throws MetadataException {
        if (!_directory.containsTag(OlympusMakernoteDirectory.TAG_OLYMPUS_SPECIAL_MODE))
            return null;
