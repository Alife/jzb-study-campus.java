 ...
 * ExifDirectory.java
 * 
 * This is public domain software - that is, you can do whatever you want with it, and include it software that is licensed under the GNU or the BSD license, or whatever other licence you choose,
 * including proprietary closed source licenses. I do ask that you leave this header in tact.
 * 
...
public class ExifDirectory extends Directory {
    ...
    /**
     * This tag indicates the equivalent focal length assuming a 35mm film camera, in mm. A value of 0 means the focal length is unknown. Note that this tag differs from the FocalLength tag. Tag =
     * 41989 (A405.H) Type = SHORT Count = 1 Default = none
     */
    public static final int        TAG_35MM_FILM_EQUIV_FOCAL_LENGTH      = 0xA405;
    /**
     * The actual aperture value of lens when the image was taken. Unit is APEX. To convert this value to ordinary F-number (F-stop), calculate this value's power of root 2 (=1.4142). For example, if
     * the ApertureValue is '5', F-number is 1.4142^5 = F5.6.
     */
    ...
    /**
     * Shows compression method for Thumbnail. 1 = Uncompressed 2 = CCITT 1D 3 = T4/Group 3 Fax 4 = T6/Group 4 Fax 5 = LZW 6 = JPEG (old-style) 7 = JPEG 8 = Adobe Deflate 9 = JBIG B&W 10 = JBIG Color
     * 32766 = Next 32771 = CCIRLEW 32773 = PackBits 32809 = Thunderscan 32895 = IT8CTPAD 32896 = IT8LW 32897 = IT8MP 32898 = IT8BL 32908 = PixarFilm 32909 = PixarLog 32946 = Deflate 32947 = DCS 34661
     * = JBIG 34676 = SGILog 34677 = SGILog24 34712 = JPEG 2000 34713 = Nikon NEF Compressed
     */
    ...
    /**
     * This tag indicates the direction of contrast processing applied by the camera when the image was shot. Tag = 41992 (A408.H) Type = SHORT Count = 1 Default = 0 0 = Normal 1 = Soft 2 = Hard Other
     * = reserved
     */
    ...
    /**
     * This tag indicates the use of special processing on image data, such as rendering geared to output. When special processing is performed, the reader is expected to disable or minimize any
     * further processing. Tag = 41985 (A401.H) Type = SHORT Count = 1 Default = 0 0 = Normal process 1 = Custom process Other = reserved
     */
    ...
    /**
     * This tag indicates information on the picture-taking conditions of a particular camera model. The tag is used only to indicate the picture-taking conditions in the reader. Tag = 41995 (A40B.H)
     * Type = UNDEFINED Count = Any Default = none
     * 
     * The information is recorded in the format shown below. The data is recorded in Unicode using SHORT type for the number of display rows and columns and UNDEFINED type for the camera settings.
     ...
     * 
     * Length Type Meaning ------+-----------+------------------ 2 SHORT Display columns 2 SHORT Display rows Any UNDEFINED Camera setting-1 Any UNDEFINED Camera setting-2 : : : Any UNDEFINED Camera
     * setting-n
     */
    public static final int        TAG_DEVICE_SETTING_DESCRIPTION        = 0xA40B;
    /**
     * This tag indicates the digital zoom ratio when the image was shot. If the numerator of the recorded value is 0, this indicates that digital zoom was not used. Tag = 41988 (A404.H) Type =
     * RATIONAL Count = 1 Default = none
     */
    ...
    /**
     * This tag indicates the exposure mode set when the image was shot. In auto-bracketing mode, the camera shoots a series of frames of the same scene at different exposure settings. Tag = 41986
     * (A402.H) Type = SHORT Count = 1 Default = none 0 = Auto exposure 1 = Manual exposure 2 = Auto bracket Other = reserved
     */
    public static final int        TAG_EXPOSURE_MODE                     = 0xA402;
    /**
     * Exposure program that the camera used when image was taken. '1' means manual control, '2' program normal, '3' aperture priority, '4' shutter priority, '5' program creative (slow program), '6'
     * program action (high-speed program), '7' portrait mode, '8' landscape mode.
     */
    ...
    /**
     * 0x0 = 0000000 = No Flash 0x1 = 0000001 = Fired 0x5 = 0000101 = Fired, Return not detected 0x7 = 0000111 = Fired, Return detected 0x9 = 0001001 = On 0xd = 0001101 = On, Return not detected 0xf =
     * 0001111 = On, Return detected 0x10 = 0010000 = Off 0x18 = 0011000 = Auto, Did not fire 0x19 = 0011001 = Auto, Fired 0x1d = 0011101 = Auto, Fired, Return not detected 0x1f = 0011111 = Auto,
     * Fired, Return detected 0x20 = 0100000 = No flash function 0x41 = 1000001 = Fired, Red-eye reduction 0x45 = 1000101 = Fired, Red-eye reduction, Return not detected 0x47 = 1000111 = Fired,
     * Red-eye reduction, Return detected 0x49 = 1001001 = On, Red-eye reduction 0x4d = 1001101 = On, Red-eye reduction, Return not detected 0x4f = 1001111 = On, Red-eye reduction, Return detected
     * 0x59 = 1011001 = Auto, Fired, Red-eye reduction 0x5d = 1011101 = Auto, Fired, Red-eye reduction, Return not detected 0x5f = 1011111 = Auto, Fired, Red-eye reduction, Return detected 6543210
     * (positions)
     * 
     * This is a bitmask. 0 = flash fired 1 = return detected 2 = return able to be detected 3 = unknown 4 = auto used 5 = unknown 6 = red eye reduction used
     */
     ...
     * 
     * Note: Some of Fujifilm's digicam(e.g.FX2700,FX2900,Finepix4700Z/40i etc) uses value '3' so it must be 'centimeter', but it seems that they use a '8.3mm?'(1/3in.?) to their ResolutionUnit.
    ...
    /**
     * This tag indicates the degree of overall image gain adjustment. Tag = 41991 (A407.H) Type = SHORT Count = 1 Default = none 0 = None 1 = Low gain up 2 = High gain up 3 = Low gain down 4 = High
     * gain down Other = reserved
     */
    ...
    /**
     * This tag indicates an identifier assigned uniquely to each image. It is recorded as an ASCII string equivalent to hexadecimal notation and 128-bit fixed length. Tag = 42016 (A420.H) Type =
     * ASCII Count = 33 Default = none
     */
    ...
    /**
     * Maximum aperture value of lens. You can convert to F-number by calculating power of root 2 (same process of ApertureValue:0x9202). The actual aperture value of lens when the image was taken. To
     * convert this value to ordinary f-number(f-stop), calculate the value's power of root 2 (=1.4142). For example, if the ApertureValue is '5', f-number is 1.41425^5 = F5.6.
     */
    ...
    /**
     * The new subfile type tag. 0 = Full-resolution Image 1 = Reduced-resolution image 2 = Single page of multi-page image 3 = Single page of multi-page reduced-resolution image 4 = Transparency mask
     * 5 = Transparency mask of reduced-resolution image 6 = Transparency mask of multi-page image 7 = Transparency mask of reduced-resolution multi-page image
     */
    ...
    /**
     * Shows the color space of the image data components. 0 = WhiteIsZero 1 = BlackIsZero 2 = RGB 3 = RGB Palette 4 = Transparency Mask 5 = CMYK 6 = YCbCr 8 = CIELab 9 = ICCLab 10 = ITULab 32803 =
     * Color Filter Array 32844 = Pixar LogL 32845 = Pixar LogLuv 34892 = Linear Raw
     */
    public static final int        TAG_PHOTOMETRIC_INTERPRETATION        = 0x0106;
    /**
     * When image format is no compression YCbCr, this value shows byte aligns of YCbCr data. If value is '1', Y/Cb/Cr value is chunky format, contiguous for each subsampling pixel. If value is '2',
     * Y/Cb/Cr value is separated and stored to Y plane/Cb plane/Cr plane format.
     */
    ...
    /**
     * This tag indicates the direction of saturation processing applied by the camera when the image was shot. Tag = 41993 (A409.H) Type = SHORT Count = 1 Default = 0 0 = Normal 1 = Low saturation 2
     * = High saturation Other = reserved
     */
    public static final int        TAG_SATURATION                        = 0xA409;
    /**
     * This tag indicates the type of scene that was shot. It can also be used to record the mode in which the image was shot. Note that this differs from the scene type (SceneType) tag. Tag = 41990
     * (A406.H) Type = SHORT Count = 1 Default = 0 0 = Standard 1 = Landscape 2 = Portrait 3 = Night scene Other = reserved
     */
    ...
    /**
     * This tag indicates the direction of sharpness processing applied by the camera when the image was shot. Tag = 41994 (A40A.H) Type = SHORT Count = 1 Default = 0 0 = Normal 1 = Soft 2 = Hard
     * Other = reserved
     */
    public static final int        TAG_SHARPNESS                         = 0xA40A;
    /**
     * Shutter speed by APEX value. To convert this value to ordinary 'Shutter Speed'; calculate this value's power of 2, then reciprocal. For example, if the ShutterSpeedValue is '4', shutter speed
     * is 1/(24)=1/16 second.
     */
    ...
    /**
     * White balance (aka light source). '0' means unknown, '1' daylight, '2' fluorescent, '3' tungsten, '10' flash, '17' standard light A, '18' standard light B, '19' standard light C, '20' D55, '21'
     * D65, '22' D75, '255' other.
     */
    public static final int        TAG_WHITE_BALANCE                     = 0x9208;

    /**
     * This tag indicates the white balance mode set when the image was shot. Tag = 41987 (A403.H) Type = SHORT Count = 1 Default = none 0 = Auto white balance 1 = Manual white balance Other =
     * reserved
     */
    ...
    /*
     * // This thumbnail extraction code is not complete, and is included to assist anyone who feels like looking into // it. Please share any progress with the original author, and hence the
     * community. Thanks.
     * 
     * /
     * 
     * @return
     * 
     * @throws MetadataException / public Image getThumbnailImage() throws MetadataException { if (!containsThumbnail()) return null;
     * 
     * int compression = 0; try { compression = this.getInt(ExifDirectory.TAG_COMPRESSION); } catch (Throwable e) { this.addError("Unable to determine thumbnail type " + e.getMessage()); }
     * 
     * final byte[] thumbnailBytes = getThumbnailData();
     * 
     * if (compression == ExifDirectory.COMPRESSION_JPEG) { // JPEG Thumbnail // operate directly on thumbnailBytes // try { // int offset = this.getInt(ExifDirectory.TAG_THUMBNAIL_OFFSET); // int
     * length = this.getInt(ExifDirectory.TAG_THUMBNAIL_LENGTH); // byte[] result = new byte[length]; // for (int i = 0; i<result.length; i++) { // result[i] = _data[tiffHeaderOffset + offset + i]; //
     * } // this.setByteArray(ExifDirectory.TAG_THUMBNAIL_DATA, result); // } catch (Throwable e) { // this.addError("Unable to extract thumbnail: " + e.getMessage()); // } // TODO decode the JPEG
     * bytes as an image return null; //new Image(); } else if (compression == ExifDirectory.COMPRESSION_NONE) { // uncompressed thumbnail (raw RGB data) if
     * (!this.containsTag(ExifDirectory.TAG_PHOTOMETRIC_INTERPRETATION)) return null;
     * 
     * try { // If the image is RGB format, then convert it to a bitmap final int photometricInterpretation = this.getInt(ExifDirectory.TAG_PHOTOMETRIC_INTERPRETATION); if (photometricInterpretation
     ...
     * ExifDirectory.PHOTOMETRIC_INTERPRETATION_MONOCHROME) { // Monochrome // TODO return null; } } catch (Throwable e) { this.addError("Unable to extract thumbnail: " + e.getMessage()); } } return
     * null; }
     * 
     ...
     * 
     * The numerics in parenthesis are pixel coordinates. DX series' YCbCrCoefficients(0x0211) has values '0.299/0.587/0.114', ReferenceBlackWhite(0x0214) has values '0,255,128,255,128,255'. Therefore
     * to convert from Y/Cb/Cr to RGB is;
     * 
     * B(0,0)=(Cb-128)(2-0.1142)+Y(0,0) R(0,0)=(Cr-128)(2-0.2992)+Y(0,0) G(0,0)=(Y(0,0)-0.114B(0,0)-0.299R(0,0))/0.587
     * 
     * Horizontal subsampling is a value '2', so you can calculate B(1,0)/R(1,0)/G(1,0) by using the Y(1,0) and Cr(0,0)/Cb(0,0). Repeat this conversion by value of ImageWidth(0x0100) and
     * ImageLength(0x0101).
     * 
     ...
     * @return
     * 
     * @throws com.drew.metadata.MetadataException / private Image createImageFromRawYCbCr(byte[] thumbnailBytes) throws MetadataException { / Y = 0.257R + 0.504G + 0.098B + 16 Cb = -0.148R - 0.291G +
     * 0.439B + 128 Cr = 0.439R - 0.368G - 0.071B + 128
     * 
     * G = 1.164(Y-16) - 0.391(Cb-128) - 0.813(Cr-128) R = 1.164(Y-16) + 1.596(Cr-128) B = 1.164(Y-16) + 2.018(Cb-128)
     * 
     * R, G and B range from 0 to 255. Y ranges from 16 to 235. Cb and Cr range from 16 to 240.
     * 
     * http://www.faqs.org/faqs/graphics/colorspace-faq/ /
     * 
     * int length = thumbnailBytes.length; // this.getInt(ExifDirectory.TAG_STRIP_BYTE_COUNTS); final int imageWidth = this.getInt(ExifDirectory.TAG_THUMBNAIL_IMAGE_WIDTH); final int imageHeight =
     * this.getInt(ExifDirectory.TAG_THUMBNAIL_IMAGE_HEIGHT); // final int headerLength = 54; // byte[] result = new byte[length + headerLength]; // // Add a windows BMP header described: // //
     * http://www.onicos.com/staff/iz/formats/bmp.html // result[0] = 'B'; // result[1] = 'M'; // File Type identifier // result[3] = (byte)(result.length / 256); // result[2] = (byte)result.length;
     * // result[10] = (byte)headerLength; // result[14] = 40; // MS Windows BMP header // result[18] = (byte)imageWidth; // result[22] = (byte)imageHeight; // result[26] = 1; // 1 Plane // result[28]
     * = 24; // Colour depth // result[34] = (byte)length; // result[35] = (byte)(length / 256);
     * 
     * final BufferedImage image = new BufferedImage(imageWidth, imageHeight, BufferedImage.TYPE_INT_RGB);
     * 
     * // order is YCbCr and image is upside down, bitmaps are BGR //// for (int i = headerLength, dataOffset = length; i<result.length; i += 3, dataOffset -= 3) // { // final int y =
     * thumbnailBytes[dataOffset - 2] & 0xFF; // final int cb = thumbnailBytes[dataOffset - 1] & 0xFF; // final int cr = thumbnailBytes[dataOffset] & 0xFF; // if (y<16 || y>235 || cb<16 || cb>240 ||
     * cr<16 || cr>240) // "".toString(); // // int g = (int)(1.164(y-16) - 0.391(cb-128) - 0.813(cr-128)); // int r = (int)(1.164(y-16) + 1.596(cr-128)); // int b = (int)(1.164(y-16) +
     * 2.018(cb-128)); // //// result[i] = (byte)b; //// result[i + 1] = (byte)g; //// result[i + 2] = (byte)r; // // // TODO compose the image here // image.setRGB(1, 2, 3); // }
     * 
     * return image; }
     * 
     ...
     * @return
     * 
     * @throws com.drew.metadata.MetadataException / private Image createImageFromRawRgb(byte[] thumbnailBytes) throws MetadataException { final int length = thumbnailBytes.length; //
     * this.getInt(ExifDirectory.TAG_STRIP_BYTE_COUNTS); final int imageWidth = this.getInt(ExifDirectory.TAG_THUMBNAIL_IMAGE_WIDTH); final int imageHeight =
     * this.getInt(ExifDirectory.TAG_THUMBNAIL_IMAGE_HEIGHT); // final int headerlength = 54; // final byte[] result = new byte[length + headerlength]; // // Add a windows BMP header described: // //
     * http://www.onicos.com/staff/iz/formats/bmp.html // result[0] = 'B'; // result[1] = 'M'; // File Type identifier // result[3] = (byte)(result.length / 256); // result[2] = (byte)result.length;
     * // result[10] = (byte)headerlength; // result[14] = 40; // MS Windows BMP header // result[18] = (byte)imageWidth; // result[22] = (byte)imageHeight; // result[26] = 1; // 1 Plane // result[28]
     * = 24; // Colour depth // result[34] = (byte)length; // result[35] = (byte)(length / 256);
     * 
     * final BufferedImage image = new BufferedImage(imageWidth, imageHeight, BufferedImage.TYPE_INT_RGB);
     * 
     * // order is RGB and image is upside down, bitmaps are BGR // for (int i = headerlength, dataOffset = length; i<result.length; i += 3, dataOffset -= 3) // { // byte b = thumbnailBytes[dataOffset
     * - 2]; // byte g = thumbnailBytes[dataOffset - 1]; // byte r = thumbnailBytes[dataOffset]; // // // TODO compose the image here // image.setRGB(1, 2, 3); // }
     * 
     * return image; }
     */
