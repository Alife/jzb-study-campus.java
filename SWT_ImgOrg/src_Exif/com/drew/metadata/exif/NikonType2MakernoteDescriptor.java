...
public class NikonType2MakernoteDescriptor extends TagDescriptor {
    ...
    public String getAutoFocusPositionDescription() throws MetadataException {
        if (!_directory.containsTag(NikonType2MakernoteDirectory.TAG_NIKON_TYPE2_AF_FOCUS_POSITION))
            return null;
    ...
    public String getDigitalZoomDescription() throws MetadataException {
        if (!_directory.containsTag(NikonType2MakernoteDirectory.TAG_NIKON_TYPE2_DIGITAL_ZOOM))
            return null;
    ...
    public String getIsoSettingDescription() throws MetadataException {
        if (!_directory.containsTag(NikonType2MakernoteDirectory.TAG_NIKON_TYPE2_ISO_1))
            return null;
