...
public class ExifDescriptor extends TagDescriptor {
    ...
    /**
     * Returns a descriptive value of the the specified tag for this image. Where possible, known values will be substituted here in place of the raw tokens actually kept in the Exif segment. If no
     * substitution is available, the value provided by getString(int) will be returned.
     * 
     * @param tagType
    ...
    public String getFocalPlaneXResolutionDescription() throws MetadataException {
        ...
        return rational.getReciprocal().toSimpleString(_allowDecimalRepresentationOfRationals) + " " + getFocalPlaneResolutionUnitDescription().toLowerCase();
    }
    ...
    public String getShutterSpeedDescription() throws MetadataException {
        ...
        /*
         * // This alternative implementation offered by Bill Richards // TODO determine which is the correct / more-correct implementation double apexValue =
         * _directory.getDouble(ExifDirectory.TAG_SHUTTER_SPEED); double apexPower = Math.pow(2.0, apexValue);
         * 
         * StringBuffer sb = new StringBuffer(); if (apexPower > 1) apexPower = Math.floor(apexPower);
         * 
         * if (apexPower < 1) { sb.append((int)Math.round(1/apexPower)); } else { sb.append("1/"); sb.append((int)apexPower); } sb.append(" sec"); return sb.toString();
         */
    ...
    public String getXResolutionDescription() throws MetadataException {
        ...
        return resolution.toSimpleString(_allowDecimalRepresentationOfRationals) + " dots per " + getResolutionDescription().toLowerCase();
    }
