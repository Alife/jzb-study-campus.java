...
/**
 * Contains values specific to Nikon cameras. Type-2 applies to the E990 and D-series cameras such as the E990, D1, D70 and D100.
 * 
 ...
 * 
 * Note that the camera implements image protection (locking images) via the file's 'readonly' attribute. Similarly image hiding uses the 'hidden' attribute (observed on the D70). Consequently, these
 ...
 * 
 * In earlier models (such as the E990 and D1), this directory begins at the first byte of the makernote IFD. In later models, the IFD was given the standard prefix to indicate the camera models (most
 * other manufacturers also provide this prefix to aid in software decoding).
 */
public class NikonType2MakernoteDirectory extends Directory {
    ...
    /**
     * Values observed - Built-in,TTL - Optional,TTL (with speedlight SB800, flash sync mode as NORMAL. NikonBrowser reports Auto Flash Comp: 0 EV -- which tag is that?) (D70) - NEW_TTL (Nikon Browser
     * interprets as "D-TTL") - (blank -- accompanied FlashSyncMode of NORMAL) (D70)
     */
     ...
     * 
     * Values observed - AUTO - SUNNY (D70) - FLASH (D1X) (presumably also SHADOW / INCANDESCENT / FLUORESCENT / CLOUDY)
     */
    ...
    /**
     * This appears to be a sequence number to indentify the exposure. This value seems to increment for consecutive exposures (observed on D70).
     * 
    ...
    /**
     * Values observed - 0100fht@7b,4x,D"Y - 01015 - 0100w\cH+D$$h$î5Q (D1X) - 30,31,30,30,0,0,b,48,7c,7c,24,24,5,15,24,0,0,0,0,0 (hex) (D100)
     */
