...
public class CasioType2MakernoteDescriptor extends TagDescriptor {
    ...
    public String getBestShotModeDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_BESTSHOT_MODE))
            return null;
    ...
    public String getCasioPreviewThumbnailDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_CASIO_PREVIEW_THUMBNAIL))
            return null;
    ...
    public String getCcdIsoSensitivityDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_CCD_ISO_SENSITIVITY))
            return null;
    ...
    public String getColourModeDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_COLOUR_MODE))
            return null;
    ...
    public String getContrastDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_CONTRAST))
            return null;
    ...
    public String getEnhancementDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_ENHANCEMENT))
            return null;
    ...
    public String getFilterDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_FILTER))
            return null;
    ...
    public String getFlashDistanceDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_FLASH_DISTANCE))
            return null;
    ...
    public String getFocalLengthDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_FOCAL_LENGTH))
            return null;
    ...
    public String getFocusMode1Description() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_FOCUS_MODE_1))
            return null;
    ...
    public String getFocusMode2Description() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_FOCUS_MODE_2))
            return null;
    ...
    public String getImageSizeDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_IMAGE_SIZE))
            return null;
    ...
    public String getIsoSensitivityDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_ISO_SENSITIVITY))
            return null;
    ...
    public String getObjectDistanceDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_OBJECT_DISTANCE))
            return null;
    ...
    public String getPrintImageMatchingInfoDescription() {
        ...
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_PRINT_IMAGE_MATCHING_INFO))
            return null;
    ...
    public String getQualityDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_QUALITY))
            return null;
    ...
    public String getQualityModeDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_QUALITY_MODE))
            return null;
    ...
    public String getRecordModeDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_RECORD_MODE))
            return null;
    ...
    public String getSaturationDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_SATURATION))
            return null;
    ...
    public String getSelfTimerDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_SELF_TIMER))
            return null;
    ...
    public String getSharpnessDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_SHARPNESS))
            return null;
    ...
    public String getThumbnailDimensionsDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_THUMBNAIL_DIMENSIONS))
            return null;
    ...
    public String getThumbnailOffsetDescription() {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_THUMBNAIL_OFFSET))
            return null;
    ...
    public String getThumbnailSizeDescription() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_THUMBNAIL_SIZE))
            return null;
    ...
    public String getTimeZoneDescription() {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_TIME_ZONE))
            return null;
    ...
    public String getWhiteBalance1Description() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_WHITE_BALANCE_1))
            return null;
    ...
    public String getWhiteBalance2Description() throws MetadataException {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_WHITE_BALANCE_2))
            return null;
    ...
    public String getWhiteBalanceBiasDescription() {
        if (!_directory.containsTag(CasioType2MakernoteDirectory.TAG_CASIO_TYPE2_WHITE_BALANCE_BIAS))
            return null;
