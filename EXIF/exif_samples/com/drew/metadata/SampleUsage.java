...
public class SampleUsage {
    ...
    public static void main(String[] args) throws Exception {
        File f = new File("./exif_samples/com/drew/metadata/withIptcExifGps.jpg");

        f = new File("/Users/jzarzuela/Desktop/jzb/backup-discoextr/_Backup_/_Fotos_/__SIN COLOCAR__/2009_07_13-23_Irlanda/Fotos_Irlanda/Filtradas_NO/Dublin/01-Hotel_00020-IMG_5382.CR2");
        Metadata metadata = ImageMetadataReader.readMetadata(f);
        for (Object obj : metadata.getDirectories()) {
            System.out.println(obj);
        }

        new SampleUsage(f.getAbsolutePath());
    }
