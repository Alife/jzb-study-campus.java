...
public class DirectoryTest {
    ...
    public void testSetStringAndGetDate() throws Exception {
        ...
        Assert.assertEquals(new GregorianCalendar(2002, Calendar.JANUARY, 30, 24, 59, 59).getTime(), _directory.getDate(1));
        Assert.assertEquals(new GregorianCalendar(2002, Calendar.JANUARY, 30, 24, 59, 0).getTime(), _directory.getDate(2));
        Assert.assertEquals(new GregorianCalendar(2002, Calendar.JANUARY, 30, 24, 59, 59).getTime(), _directory.getDate(3));
        Assert.assertEquals(new GregorianCalendar(2002, Calendar.JANUARY, 30, 24, 59, 0).getTime(), _directory.getDate(4));
    }
    ...
    public void testUnderlyingInt() throws Exception {
        ...
        Assert.assertEquals(value, _directory.getFloat(tagType), 0.00001);
        Assert.assertEquals(value, _directory.getDouble(tagType), 0.00001);
        Assert.assertEquals(value, _directory.getLong(tagType));
