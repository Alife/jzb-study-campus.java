...
/**
 * A sample application that creates HTML that shows image positions on a Google Map according to the GPS data contained within each {@link GpsDirectory}, if available.
 */
