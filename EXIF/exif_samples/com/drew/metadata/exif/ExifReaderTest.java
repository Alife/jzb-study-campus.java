...
public class ExifReaderTest {
    ...
    /*
     * public void testUncompressedYCbCrThumbnail() throws Exception { String fileName = "Tests/com/drew/metadata/exif/withUncompressedYCbCrThumbnail.jpg"; String thumbnailFileName =
     * "Tests/com/drew/metadata/exif/withUncompressedYCbCrThumbnail.bmp"; Metadata metadata = new ExifReader(new File(fileName)).extract(); ExifSubIFDDirectory directory =
     * (ExifSubIFDDirectory)metadata.getOrCreateDirectory(ExifSubIFDDirectory.class); directory.writeThumbnail(thumbnailFileName);
     * 
     * fileName = "Tests/com/drew/metadata/exif/withUncompressedYCbCrThumbnail2.jpg"; thumbnailFileName = "Tests/com/drew/metadata/exif/withUncompressedYCbCrThumbnail2.bmp"; metadata = new
     * ExifReader(new File(fileName)).extract(); directory = (ExifSubIFDDirectory)metadata.getOrCreateDirectory(ExifSubIFDDirectory.class); directory.writeThumbnail(thumbnailFileName); fileName =
     * "Tests/com/drew/metadata/exif/withUncompressedYCbCrThumbnail3.jpg"; thumbnailFileName = "Tests/com/drew/metadata/exif/withUncompressedYCbCrThumbnail3.bmp"; metadata = new ExifReader(new
     * File(fileName)).extract(); directory = (ExifSubIFDDirectory)metadata.getOrCreateDirectory(ExifSubIFDDirectory.class); directory.writeThumbnail(thumbnailFileName); fileName =
     * "Tests/com/drew/metadata/exif/withUncompressedYCbCrThumbnail4.jpg"; thumbnailFileName = "Tests/com/drew/metadata/exif/withUncompressedYCbCrThumbnail4.bmp"; metadata = new ExifReader(new
     * File(fileName)).extract(); directory = (ExifSubIFDDirectory)metadata.getOrCreateDirectory(ExifSubIFDDirectory.class); directory.writeThumbnail(thumbnailFileName); }
     * 
     * public void testUncompressedRGBThumbnail() throws Exception { String fileName = "Tests/com/drew/metadata/exif/withUncompressedRGBThumbnail.jpg"; String thumbnailFileName =
     * "Tests/com/drew/metadata/exif/withUncompressedRGBThumbnail.bmp"; Metadata metadata = new ExifReader(new File(fileName)).extract(); ExifSubIFDDirectory directory =
     * (ExifSubIFDDirectory)metadata.getOrCreateDirectory(ExifSubIFDDirectory.class); directory.writeThumbnail(thumbnailFileName); }
     */
