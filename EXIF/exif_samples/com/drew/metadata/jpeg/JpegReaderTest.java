...
public class JpegReaderTest {
    ...
    /*
     * // this test is part of an incomplete investigation into extracting audio from JPG files public void testJpegWithAudio() throws Exception { // use a known testing image File jpegFile = new
     * File("Tests/com/drew/metadata/jpeg/audioPresent.jpg");
     * 
     * JpegSegmentReader jpegSegmentReader = new JpegSegmentReader(jpegFile); byte[] segment1Bytes = jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APP2);
     * System.out.println(segment1Bytes.length);
     * 
     * // System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APP1)); System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APP2).length); //
     * System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APP3)); // System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APP4)); //
     * System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APP5)); // System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APP6)); //
     * System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APP7)); // System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APP8)); //
     * System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APP9)); // System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APPA)); //
     * System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APPB)); // System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APPC)); //
     * System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APPD)); // System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APPE)); //
     * System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_APPF)); // System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_COM));
     * System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_DHT).length); System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_DQT).length);
     * System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_SOF0).length); // System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SEGMENT_SOI));
     * 
     * // write the segment's data out to a wav file... File audioFile = new File("Tests/com/drew/metadata/jpeg/audio.wav"); FileOutputStream os = null; try { os = new FileOutputStream(audioFile);
     * os.write(segment1Bytes); } finally { if (os!=null) os.close(); } }
     */
}
