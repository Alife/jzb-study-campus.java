...
public class XmpReaderTest {
    ...
    /*
     * [Xmp] Lens Information = 24/1 70/1 0/0 0/0 [Xmp] Lens = EF24-70mm f/2.8L USM [Xmp] Serial Number = 380319450 [Xmp] Firmware = 1.2.1 [Xmp] Make = Canon [Xmp] Model = Canon EOS 7D [Xmp] Exposure
     * Time = 1/125 sec [Xmp] Exposure Program = Manual control [Xmp] Aperture Value = F11 [Xmp] F-Number = F11 [Xmp] Focal Length = 57.0 mm [Xmp] Shutter Speed Value = 1/124 sec [Xmp] Date/Time
     * Original = Sun Dec 12 11:41:35 GMT 2010 [Xmp] Date/Time Digitized = Sun Dec 12 11:41:35 GMT 2010
     */
     ...
     * 
     * @Test public void testExtract_Format() throws Exception { Assert.assertEquals("image/tiff", _directory.getString(XmpDirectory.TAG_FORMAT)); }
     * 
     * @Test public void testExtract_Creator() throws Exception { Assert.assertEquals("", _directory.getString(XmpDirectory.TAG_CREATOR)); }
     * 
     * @Test public void testExtract_Rights() throws Exception { Assert.assertEquals("", _directory.getString(XmpDirectory.TAG_RIGHTS)); }
     * 
     * @Test public void testExtract_Description() throws Exception { Assert.assertEquals("", _directory.getString(XmpDirectory.TAG_DESCRIPTION)); }
     */
