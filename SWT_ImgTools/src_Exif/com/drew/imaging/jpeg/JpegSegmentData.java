...
/**
 * Holds a collection of Jpeg data segments. This need not necessarily be all segments within the Jpeg. For example, it may be convenient to port about only the non-image segments when analysing (or
