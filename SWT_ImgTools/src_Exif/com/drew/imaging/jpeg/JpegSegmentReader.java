...
/**
 * Performs read functions of Jpeg files, returning specific file segments. TODO add a findAvailableSegments() method TODO add more segment identifiers TODO add a getSegmentDescription() method,
 * returning for example 'App1 application data segment, commonly containing Exif data'
 * 
...
public class JpegSegmentReader {
     ...
     *             for any problems processing the Jpeg data, including inner IOExceptions
     */
     ...
     * 
     * @param fileStream
     *            the InputStream to read bytes from, which must be positioned at its start (i.e. no bytes read yet)
