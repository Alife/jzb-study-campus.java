...
public class JpegDirectory extends Directory {
    ...
    /**
     * Usually 1 = grey scaled, 3 = color YcbCr or YIQ, 4 = color CMYK Each component TAG_COMPONENT_DATA_[1-4], has the following meaning: component Id(1byte)(1 = Y, 2 = Cb, 3 = Cr, 4 = I, 5 = Q),
     * sampling factors (1byte) (bit 0-3 vertical., 4-7 horizontal.), quantization table number (1 byte).
     * <p>
     ...
     *            The zero-based index of the component. This number is normally between 0 and 3. Use getNumberOfComponents for bounds-checking.
     * @return
     */
