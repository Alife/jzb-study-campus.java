...
public abstract class Directory implements Serializable {
     ...
     *             if the tag has not been set, or cannot be converted to a byte array
     */
     ...
     * @throws MetadataException
     *             if a descriptor hasn't been set, or if an error occurs during calculation of the description within the Descriptor
     */
     ...
     * @throws MetadataException
     *             if the tag has not been set, or cannot be converted to an int array
     */
     ...
     * @throws MetadataException
     *             if the tag has not been set or cannot be represented as a String[]
     */
