...
/**
 * Provides human-readable string versions of the tags stored in a NikonType1MakernoteDirectory. Type-1 is for E-Series cameras prior to (not including) E990. For example: E700, E800, E900, E900S,
 * E910, E950.
 * 
 * MakerNote starts from ASCII string "Nikon". Data format is the same as IFD, but it starts from offset 0x08. This is the same as Olympus except start string. Example of actual data structure is
 * shown below.
 * 
 * <pre>
 * &lt;code&gt;
...
public class NikonType1MakernoteDescriptor extends TagDescriptor {
    ...
    public String getCcdSensitivityDescription() throws MetadataException {
        if (!_directory.containsTag(NikonType1MakernoteDirectory.TAG_NIKON_TYPE1_CCD_SENSITIVITY))
            return null;
    ...
    public String getColorModeDescription() throws MetadataException {
        if (!_directory.containsTag(NikonType1MakernoteDirectory.TAG_NIKON_TYPE1_COLOR_MODE))
            return null;
    ...
    public String getConverterDescription() throws MetadataException {
        if (!_directory.containsTag(NikonType1MakernoteDirectory.TAG_NIKON_TYPE1_CONVERTER))
            return null;
    ...
    public String getDigitalZoomDescription() throws MetadataException {
        if (!_directory.containsTag(NikonType1MakernoteDirectory.TAG_NIKON_TYPE1_DIGITAL_ZOOM))
            return null;
    ...
    public String getFocusDescription() throws MetadataException {
        if (!_directory.containsTag(NikonType1MakernoteDirectory.TAG_NIKON_TYPE1_FOCUS))
            return null;
    ...
    public String getImageAdjustmentDescription() throws MetadataException {
        if (!_directory.containsTag(NikonType1MakernoteDirectory.TAG_NIKON_TYPE1_IMAGE_ADJUSTMENT))
            return null;
    ...
    public String getQualityDescription() throws MetadataException {
        if (!_directory.containsTag(NikonType1MakernoteDirectory.TAG_NIKON_TYPE1_QUALITY))
            return null;
    ...
    public String getWhiteBalanceDescription() throws MetadataException {
        if (!_directory.containsTag(NikonType1MakernoteDirectory.TAG_NIKON_TYPE1_WHITE_BALANCE))
            return null;
